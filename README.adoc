...
If you encounter any bugs, glitches, lack of functionality, or other issues with the repository, https://github.com/e-Spirit/crownpeak-pwa-template/issues[please let us know] so that we can address them appropriately.
