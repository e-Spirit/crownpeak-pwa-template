...
You can use it as a playground or as a foundation for a xref:./ProjectToSiteMapping.adoc[company scale hosting solution].

To get more details on how to map your deployments for an enterprise scaled project, see chapter REPLACE ME.
