...
In the FSXA example project https://docs.e-spirit.com/module/fsxa/ueberblick/bestandteile-fs/sl-global/index.html[Smart Living Global] a `Theming` tab allows you to quickly modify _project settings_ such as `button color`, `text highlighting color` or `banner opacity`.
