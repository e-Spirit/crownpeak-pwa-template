...
If you use different URL Factories, we cannot guarantee that the navigation component inside the fsxa-api can handle it properly. 

== Clone and Configure PWA
Get the link:https://github.com/e-Spirit/fsxa-nuxt3-pwa[Crownpeak PWA template from github].
