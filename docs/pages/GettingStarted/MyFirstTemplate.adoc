...
. Clone the project using the terminal command `git clone https://github.com/e-Spirit/crownpeak-pwa-template.git`. The project should be downloaded into a folder called `fsxa-nuxt3-pwa`.
