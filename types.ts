import type { Image, DataEntry, RichTextElement, Dataset } from 'fsxa-api'
...
export interface ProductData {
  tt_categories: Dataset[]
  tt_description: RichTextElement[]
  tt_image: Image
  tt_image_alt_text: string
  tt_name: string
  tt_price: string
  tt_teaserText: string
}
